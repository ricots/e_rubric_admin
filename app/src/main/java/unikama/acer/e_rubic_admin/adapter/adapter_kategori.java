...
public class adapter_kategori extends RecyclerView.Adapter<adapter_kategori.DataObjectHolder>{
    private ArrayList<Item_kategori> mDataset;
    private Context context;
    String id_kat,result;
    final List<Item_penilaian> list_penilaian = new ArrayList<>();

    public adapter_kategori(ArrayList<Item_kategori> mDataset) {
